    ...
    public class ManagerController : MBaseController
    {
        ...
        public void GetMovingValue()
        {
            ...
            try
            {
                ...
                {
                    ViewBag.TotalOut = Convert.ToDecimal(_Ds.Tables[0].Rows[0].Field<decimal>("TotalOutstanding")).ToString("#,##0.##");
                    ViewBag.OverdueOut = Convert.ToDecimal(_Ds.Tables[0].Rows[0].Field<decimal>("OverdueOutstanding")).ToString("#,##0.##");
                }
