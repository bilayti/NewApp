...
namespace NewApp.css.CrRPT {
    ...
    public class Export_New_2 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "NewApp.css.CrRPT.Export_New-2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedExport_New_2 : Component, ICachedReport {
        
        public CachedExport_New_2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Export_New_2 rpt = new Export_New_2();
            rpt.Site = this.Site;
            return rpt;
        }
