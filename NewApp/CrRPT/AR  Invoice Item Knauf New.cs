...
namespace NewApp.CrRPT {
    ...
    public class AR__Invoice_Item_Knauf_New : ReportClass {
        
        public AR__Invoice_Item_Knauf_New() {
        }
        
        public override string ResourceName {
            get {
                return "AR  Invoice Item Knauf New.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "NewApp.CrRPT.AR  Invoice Item Knauf New.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedAR__Invoice_Item_Knauf_New : Component, ICachedReport {
        
        public CachedAR__Invoice_Item_Knauf_New() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            AR__Invoice_Item_Knauf_New rpt = new AR__Invoice_Item_Knauf_New();
            rpt.Site = this.Site;
            return rpt;
        }
