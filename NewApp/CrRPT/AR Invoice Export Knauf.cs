...
namespace NewApp.CrRPT {
    ...
    public class AR_Invoice_Export_Knauf : ReportClass {
        
        public AR_Invoice_Export_Knauf() {
        }
        
        public override string ResourceName {
            get {
                return "AR Invoice Export Knauf.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "NewApp.CrRPT.AR Invoice Export Knauf.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedAR_Invoice_Export_Knauf : Component, ICachedReport {
        
        public CachedAR_Invoice_Export_Knauf() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            AR_Invoice_Export_Knauf rpt = new AR_Invoice_Export_Knauf();
            rpt.Site = this.Site;
            return rpt;
        }
