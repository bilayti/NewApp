...
namespace NewApp.CrRPT {
    ...
    public class AR__Invoice_Item_Knauf : ReportClass {
        
        public AR__Invoice_Item_Knauf() {
        }
        
        public override string ResourceName {
            get {
                return "AR  Invoice Item Knauf.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "NewApp.CrRPT.AR  Invoice Item Knauf.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedAR__Invoice_Item_Knauf : Component, ICachedReport {
        
        public CachedAR__Invoice_Item_Knauf() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            AR__Invoice_Item_Knauf rpt = new AR__Invoice_Item_Knauf();
            rpt.Site = this.Site;
            return rpt;
        }
